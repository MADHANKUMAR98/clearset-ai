-- ============================================================================
-- CLEARSET AI — COMPLETE SNOWFLAKE SETUP (MILESTONE 1)
-- Domain: Financial Services / Capital Markets / Post-Trade Operations
-- This file contains: Schema + Tables + Seeds + Views + Validation
-- ============================================================================
...
-- 3. VALIDATION: COUNTERPARTY CP-192 PROFILE
SELECT 
    CP_ID,
    NAME,
    BIC,
...
-- 6. VALIDATION: EXCEPTION & RISK SCORE FOR TRD-92831
SELECT 
    EXCEPTION_ID,
    TRADE_ID,
    SEVERITY,
...
-- 7. VALIDATION: HISTORICAL CASES PRECEDENTS FOR CP-192
SELECT 
    HISTORICAL_CASE_ID,
    ORIGINAL_TRADE_ID,
    CASE_DATE,
...
-- 9. VALIDATION: V_EXCEPTIONS_ENRICHED
SELECT 
    TRADE_ID,
    TICKER,
    COUNTERPARTY_NAME,
...
-- 10. VALIDATION: V_CRITICAL_APPROACHING_CUTOFF
SELECT * FROM V_CRITICAL_APPROACHING_CUTOFF;

-- 11. VALIDATION: V_COUNTERPARTY_FAIL_STATS
